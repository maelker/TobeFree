<?php
/* Smarty version 3.1.30, created on 2018-04-03 17:58:22
  from "/home/tobefree/Documents/TobeFree/projet/sources/critere/critere.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5ac3a49ec9b330_06910704',
...
function content_5ac3a49ec9b330_06910704 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!doctype html>
<html lang="fr">
	<body>
		<div class="corps">
			...
			<form method="post" action="" >
				<span class="deroule" onclick="javascript:toggleDisplay(this,'meridien')"><img src="sources/images/flecheBas.png" width="25" height="25"> Selection du méridien</span>
...
?>
				...
				<span class="deroule" onclick="javascript:toggleDisplay(this,'type')"><img src="sources/images/flecheBas.png" width="25" height="25">Selection du type de pathologie</span>
				<fieldset id="type">
					<?php
...
?>
				...
				<span class="deroule" onclick="javascript:toggleDisplay(this,'caract')"><img src="sources/images/flecheBas.png" width="25" height="25">Selection des caractéristiques</span>
				<fieldset id="caract">
					<?php
